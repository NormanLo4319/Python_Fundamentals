# Python Fundamentals
In this repository, we explore the world of Python and learn how to become a "Pythonic" programmer.  We are using ["Jupyter Notebook"](https://jupyter.org/) as our execution environment in this project. Please read and follow the installation instructions of Anaconda for using the Jupyter Notebook for coding in this project.
